...
public class GestReparacaoFacade implements IGestReparacao {
	...
	public Map<String,Peca> getAllPecas(){
		Map<String,Peca> res = new HashMap<>();
        for(Peca pc : this.pecas.values()){
            res.put(pc.getIdPeca() , pc);
        }   
        return res;
	}
	...
	public Map<String,Reparacao> getAllReparacoes() {
		Map<String,Reparacao> res = new HashMap<>();
        for(Reparacao r : this.reparacoes.values()){
            res.put(r.getIdReparacao() , r);
        }   
        return res;
	}
	...
	public Map<String,ServicoExpresso> getAllServicoExpresso() {
		Map<String,ServicoExpresso> res = new HashMap<>();
        for(ServicoExpresso s : this.servicos.values()){
            res.put(s.getIdServico() , s);
        }   
        return res;
	}
